...
<head>
    ...
    <title>Registration Form- resturant info</title>
    <link rel="stylesheet" href="{{ asset('css/registration-owner-2.css')}}">
        ...
        <div class="form-container">
            <div class="form-header">
                <div class="form-header__title">
                    <div class="form-header__number">2</div>
                    <h2 class="form-header__text">Resturant info</h2>
                </div>
            ...
            <form action="{{route('store-2')}}" class="form"  method="POST">
            @csrf
                <div class="form__group">
                    <label class="form__label" for="fullName">*Resturant name</label>
                    <input type="text" id="resturantName" name="resturantName" class="form__input" required>
                </div>
                ...
                <div class="form__group">
                    <label class="form__label">*What's the kind of your resturant?</label>
                        ...
                        <div class="categories-grid" >
                            ...
                            <div class="category-card" data-type="fine Dining">
                                <img src="{{ asset('images\high-angle-table-arrangement-with-delicious-food.jpg')}}" alt="Fine Dining" class="category-image">
                                <div class="category-overlay"></div>
                                <h2 class="category-title">Fine Dining</h2>
                            </div>
                            
                            <div class="category-card" data-type="Café">
                                <img src="{{ asset('images\coffee-machine-making-coffee-bar.jpg')}}" alt="Café" class="category-image">
                                <div class="category-overlay"></div>
                                <h2 class="category-title">Café</h2>
                            </div>
                            
                            <div class="category-card"  data-type="Fast Food">
                                <img src="{{ asset('images\top-view-fast-food-mix-mozzarella-sticks-club-sandwich-hamburger-mushroom-pizza-caesar-shrimp-salad-french-fries-ketchup-mayo-cheese-sauces-table.jpg')}}" alt="Fast Food" class="category-image">
                                <div class="category-overlay"></div>
                                <h2 class="category-title">Fast Food</h2>
                            </div>
                            
                            <div class="category-card"  data-type="Casual Dining">
                                <img src="{{ asset('images\people-enjoying-feast-first-day-passover-seder.jpg')}}" alt="Casual Dining" class="category-image">
                                <div class="category-overlay"></div>
                                <h2 class="category-title">Casual Dining</h2>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.querySelectorAll(".category-card").forEach(card => {
            card.addEventListener("click", function() {
                ...
                // Supprimer la classe 'selected' des autres catégories
                document.querySelectorAll(".category-card").forEach(c => c.classList.remove("selected"));
    
                // Ajouter la classe 'selected' à l'élément cliqué
                this.classList.add("selected");
    
                // Envoyer la sélection via AJAX
