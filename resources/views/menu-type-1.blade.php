...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/menu-type-1.css')}}">
    ...
    <main class="main">
        <div class="container">
            <!-- Title -->
         <div class="salty-food">{{ $categoryName ?? 'Salty food' }}</div>
               <!-- Form for food items -->
              <form action="{{ route('menu.store', ['restaurant' => $restaurant_id]) }}" method="POST" enctype="multipart/form-data" id="food-items-form">
                 @csrf
...
<div class="next-type-container">
    <button type="submit" class="btn btn-next">Save Salty Foods</button>
</div>
