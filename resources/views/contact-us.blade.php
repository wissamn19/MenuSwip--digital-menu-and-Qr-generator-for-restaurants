...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            <a href="{{ url('landing-page.html')}}" class="nav-link">Home</a>
            <a href="{{ url('landing-page.html')}}" class="nav-link">How it works ?</a>
            <a href="{{ url('landing-page.html')}}" class="nav-link">About Us</a>
...
<a href="{{ url('registration-owner') }}" class="btn btn-register">
    ...
    <div id="contact" class="contact-us-background">
        <div class="content">
            ...
            <div class="box">
               ...
               <span><span class="address-title"> Address:</span><span class="address"> DZ, BBA, 19088, 36.0923, 5.6833, Peoples Democratic <br />Republic of Algeria </span></span>
                <span><span class="phone-title"> Phone number : </span><span class="phone-number">  +213 00-00-00-00 </span></span>
            <span><span class="email-title"> Email : </span><span class="email"> menuswip@gmail.com </span></span>
        ...
        <img class="deco-image-1" src="{{ asset ('asset images\white-vegetable-healthy-fresh-natural-10.png')}}" />
